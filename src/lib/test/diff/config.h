...
//#define BITSIZEOF_PTRDIFF_T 1

/* Define to the number of bits in type 'sig_atomic_t'. */
//#define BITSIZEOF_SIG_ATOMIC_T 1

/* Define to the number of bits in type 'size_t'. */
//#define BITSIZEOF_SIZE_T 1

/* Define to the number of bits in type 'wchar_t'. */
//#define BITSIZEOF_WCHAR_T 1

/* Define to the number of bits in type 'wint_t'. */
//#define BITSIZEOF_WINT_T 1
...
//#define PACKAGE_PACKAGER 1

/* Packager info for bug reports (URL/e-mail/...) */
//#define PACKAGE_PACKAGER_BUG_REPORTS 1

/* Packager-specific version information */
//#define PACKAGE_PACKAGER_VERSION 1
...
//#define re_compile_fastmap 1

/* Define to rpl_re_compile_pattern if the replacement should be used. */
//#define re_compile_pattern 1
...
//#define re_search_2 1

/* Define to rpl_re_set_registers if the replacement should be used. */
//#define re_set_registers 1

/* Define to rpl_re_set_syntax if the replacement should be used. */
//#define re_set_syntax 1

/* Define to rpl_re_syntax_options if the replacement should be used. */
//#define re_syntax_options 1
