...
CC_OPT += -D__GENODE__
CC_OPT += -D_IEEE_LIBM
CC_OPT += -D__LITTLE_ENDIAN
CC_OPT += -fno-strict-aliasing
CC_OPT += -std=c99

# Disable some warnings
CC_OPT += -Wno-sign-compare -Wno-unknown-pragmas -Wno-parentheses
CC_OPT += -Wno-unused-const-variable -Wno-unused-variable
CC_OPT += -Wno-maybe-uninitialized -Wno-misleading-indentation
CC_OPT += -Wno-unused-but-set-variable

LIBS += libc

vpath %.c $(call select_from_ports,fdlibm)/fdlibm
include $(call select_from_repositories,lib/import/import-fdlibm.mk)
